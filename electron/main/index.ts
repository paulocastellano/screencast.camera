import { app, BrowserWindow, shell, ipcMain, Tray, nativeImage, Menu, webFrame } from 'electron'
...
app.whenReady().then(() => {
  ...
  tray.setToolTip('ScreenCast.camera')
});
